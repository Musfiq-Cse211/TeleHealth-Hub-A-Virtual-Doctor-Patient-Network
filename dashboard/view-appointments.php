...
<?php
if(isset($_GET['id'])) {
  $sql ="DELETE FROM `appointment_info` WHERE id='$_GET[id]'";
...
<div class="popup popup--icon -question js_question-popup popup--visible">
  ...
  <div class="popup__content">
    <h3 class="popup__content__title">
      ...
      <p>
        <a href="view-appointments.php?id=<?php echo $_GET['delid']; ?>"
...
if(isset($_SESSION['patientid'])) {
    $sql  = $sql . " WHERE P_email='".$_SESSION["email"]."'";
}
$qsql = mysqli_query($conn, $sql);
while($rs = mysqli_fetch_array($qsql)) {
    echo "<tr>
          ...
          <td>&nbsp;$rs[P_address]</td>
          <td>";
    echo "  <a href='view-appointments.php?delid=$rs[id]' class='btn btn-xs btn-danger'>Delete</a>";
    echo "</td></tr>";
}
?>
                  </tbody>
