  ...
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-lg-6 px-4 pb-4" id="order">
        <h4 class="text-center pt-5">Complete your order!</h4>
        ...
        <form action="" method="post" id="placeOrder">
          ...
          <div class="form-group">
            <input type="number" id="phone_number" name="phone" class="form-control" placeholder="Enter Phone" pattern="01[3-9]\d{8}" required>
          </div>
          <div class="form-group">
