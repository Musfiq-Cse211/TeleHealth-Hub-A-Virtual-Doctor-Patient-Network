  ...
  <body>
    ...
    <div class="container first-part mt-5 p-5">
      <div class="row d-flex justify-content-center align-items-center">
        <div class="col-md-6 mx-5">
          <img src="../image/doc-new.png" class="img-fluid" alt="">
        </div>
        <div class="col-md-5">
          <h2 class="mt-3">Prof. Dr. Jamal Khan</h2>
          <h5><i class="fas fa-arrow-circle-right"></i> Fees: 500.00TK</h5>
    ...
    ?>
            ...
            <select class="form-select mb-3" name="doctors-name" aria-label="Default select example">
              ...
              <option value="Prof. Dr. Jamal Khan">Prof. Dr. Jamal Khan</option>
            </select>
