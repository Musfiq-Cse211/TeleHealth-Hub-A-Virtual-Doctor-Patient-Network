...
$sql_manage = "select * from manage_website";
        ...
        $sql = "SELECT * FROM patient WHERE status='Active' ";
                            ...
                            <div class="col-xl-3 col-md-6">
                                ...
                                ?>
                                                ...
                                                <h6 class="text-white m-b-0">Healthcare Earning</h6>
                                            </div>
                                            <div class="col-4 text-right">
                            ...
                            <?php } elseif($_SESSION['user'] == 'doctor') { ?>
                            <div class="row col-sm-12">
                                <h3>Welcome
                                    <?php echo 'Dr. '.$_SESSION['fname']; ?>
                                </h3><br><br>
                            </div>
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-c-green update-card">
                                    <div class="card-block">
                                        <div class="row align-items-end">
                                            <div class="col-8">
                                                ...
                                                <h4 class="text-white">
                                                    <?php
                                    $sql = "SELECT * FROM appointment_info WHERE Appointment_date=' ".date("Y-m-d")."'";
                                $qsql = mysqli_query($conn, $sql);
                                echo mysqli_num_rows($qsql);
                                ?>
                                                </h4>
  ...
  $sql = "SELECT * FROM patient WHERE status='Active' ";
                            ...
                            <?php } elseif($_SESSION['user'] == 'patient') {
                            ...
                            <div class="row col-lg-12">Welcome online healthcare system <br><br></div>
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <div class="tab-content card-block">
                                                <div class="tab-pane active" id="home3" role="tabpanel">
                                                    ...
                                                    <h3>You are with us from
                                                        <?php echo $rspatient['admissiondate']; ?>
                                                ...
                                                <div class="tab-pane" id="profile3" role="tabpanel">
                                                    ...
                                                    <h3>Last Appointment taken on -
                                                        ...
                                                        <?php echo $rspatientappointment['appointmenttime']; ?>
                                                    </h3>
                                                    <?php
                                                        }
                                ?>
