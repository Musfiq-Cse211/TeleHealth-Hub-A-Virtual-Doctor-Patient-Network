  ...
  <body>
    ...
    <div class="container first-part mt-5 p-5">
      <div class="row d-flex justify-content-center align-items-center">
        <div class="col-md-6 mx-5">
          <img src="../image/doc-5.jpg" class="img-fluid" alt="">
        </div>
        <div class="col-md-5">
          <h2 class="mt-3">Dr. Shamsuzzaman</h2>
          <h5><i class="fas fa-arrow-circle-right"></i> Fees: 550.00TK</h5>
    ...
    ?>
            ...
            <select class="form-select mb-3" name="doctors-name" aria-label="Default select example">
              ...
              <option value="Prof. Dr. Jamal Khan">Dr. Shamsuzzaman</option>
            </select>
