...
if(isset($_GET['id'])) {
    $sql ="DELETE FROM treatment WHERE id='$_GET[id]'";
...
<div class="popup popup--icon -question js_question-popup popup--visible">
  ...
  <div class="popup__content">
    <h3 class="popup__content__title">
      ...
      <p>
        <a href="view-treatment.php?id=<?php echo $_GET['delid']; ?>"
...
while($rs = mysqli_fetch_array($qsql)) {
    ...
    if(isset($_SESSION['adminid'])) {
        echo "<td>&nbsp;
            <a href='treatment.php?editid=$rs[id]' class='btn btn-primary'>Edit</a> 
            <a href='view-treatment.php?delid=$rs[id]' class='btn btn-danger'>Delete</a> </td>";
    }
    echo "</tr>";
}
?>
